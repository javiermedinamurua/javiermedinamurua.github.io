                    ...
                    <div class="row"> <!-- nested row -->
                        ...
                        <div class="col-md-4">  
                            <div class="contact-detail">
                                ...
                                <h4>Monterrey, México</h4> <!-- address -->
                            </div>
                        </div>
                        <!-- contact detail using col 4 -->
                        <div class="col-md-4">
                            <div class="contact-detail">
                                ...
                                <h4>javierimedinam@gmail.com</h4><!-- email add -->
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="contact-detail">
                                ...
                                <h4>(+52) 81 8139 3919</h4> <!-- phone no. -->
                            </div>
                        </div>
            ...
            <div class="row text-center"> <!-- contact form outer row with centered text-->
                <div class="col-md-10 col-md-offset-1"> <!-- col 10 with offset 1 to centered -->
                    <form id="contact-form" class="form" name="sentMessage" novalidate> <!-- form wrapper -->
                        ...
                        <div class="row"> <!-- nested inner row -->
                            ...
                            <div class="col-md-4">
                                <div class="form-group"> <!-- Your name input -->
                                    <input type="text" autocomplete="off" class="form-control" placeholder="Nombre *" id="name" required data-validation-required-message="Por favor, incluir algún nombre o pseudónimo.">
                            ...
                            <div class="col-md-4">
                                <div class="form-group"> <!-- Your email input -->
                                    <input type="email" autocomplete="off" class="form-control" placeholder="e-mail *" id="email" required data-validation-required-message="Por favor, incluir un correo electrónico.">
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group"> <!-- Your email input -->
                                    <input type="text" autocomplete="off" class="form-control" placeholder="# de teléfono" id="phone" required data-validation-required-message="">
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                        ...
                        <!-- Message Text area -->
                        <div class="form-group"> <!-- Your email input -->
                            <textarea class="form-control" rows="7" placeholder="Escribir un mensaje con confianza" id="message" required data-validation-required-message="Por favor, incluir algún mensaje o asunto."></textarea>
                            <p class="help-block text-danger"></p>
                            <div id="success"></div>
                        </div>
                        <button type="submit" class="btn btn-primary btn color">Enviar</button> <!-- Send button -->
