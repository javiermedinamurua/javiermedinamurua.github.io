<?php
if (!class_exists('Online_Portfolio_Timeline_Widget')) {
    class Online_Portfolio_Timeline_Widget extends WP_Widget
    {
        ...
        private function defaults()
        {
            ...
            $defaults = array(
                'title' => esc_html__('My Expericence', 'online-portfolio'),
                'sub-title' => '',
                'resources' => '',
                'section-id' => '',
        ...
        {
            parent::__construct(
                'business_timeline_widget',
                esc_html__('AT : Timelines Widget', 'online-portfolio'),
                array('description' => esc_html__('Business Timelines Section', 'online-portfolio'))
            );
        }
        ...
        public function form($instance)
        {
            ...
            <p>
                ...
                <input type="text" name="<?php echo esc_attr($this->get_field_name('section-id')); ?>" class="widefat"
                       id="<?php echo esc_attr($this->get_field_id('section-id')); ?>"
            ...
            <a class="at-ample-add button" data-id="online-portfolio_resource_widget"
               id="<?php echo esc_attr($repeater_id); ?>"><?php _e('Add New Section', 'online-portfolio'); ?></a>
        ...
        public function widget($args, $instance)
        {
            ...
            ============================-->
                <section id="<?php echo esc_attr($section_id); ?>">
                    ...
                    <div id="sevices" class="timeline-1">
...
add_action('widgets_init', 'online_portfolio_timeline_widget');
function online_portfolio_timeline_widget()
{
    register_widget('Online_Portfolio_Timeline_Widget');
