<?php
if (!class_exists('Online_Portfolio_Recent_Post_Widget')) {
    class Online_Portfolio_Recent_Post_Widget extends WP_Widget
    {
        ...
        private function defaults()
        {
            ...
            $defaults = array(
                'cat_id' => 0,
                'title' => esc_html__('Latest Blogs', 'online-portfolio'),
                'sub-title' => '',
                'section-id' =>'',
        ...
        {
            parent::__construct(
                'online-portfolio-recent-post-widget',
                esc_html__(' AT : Latest Blog Widget', 'online-portfolio'),
                array('description' => esc_html__('Business Latest Blog Section', 'online-portfolio'))
            );
        }
        ...
        public function form($instance)
        {
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('cat_id')); ?>">
                    <?php esc_html_e('Select Category', 'online-portfolio'); ?>
                </label><br/>
                <?php
                $business_con_dropown_cat = array(
                    'show_option_none' => esc_html__('From Recent Posts', 'online-portfolio'),
                    'orderby' => 'name',
                    'order' => 'asc',
                    'show_count' => 1,
                    'hide_empty' => 1,
                        ...
                        <!-- Single blog item -->
                                                ...
                                                <div class="col-md-4 wow fadeInUp">
                                                    <div class="about-col">
                                                        ...
                                                        <p>    <a href="<?php the_permalink();?>" class="continue-link"><?php esc_html_e('Learn More >>', 'online-portfolio'); ?></a>
                                                        </p>
...
add_action('widgets_init', 'online_portfolio_recent_post_widget');
function online_portfolio_recent_post_widget()
{
    register_widget('Online_Portfolio_Recent_Post_Widget');
